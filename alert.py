...
trip_date = datetime(2025, 1, 9)  # What is the latest appointment you want? 
sessions_token = "https://www.ch-edoc-reservation.admin.ch/#/session?token=gqs64h4F&locale=en-US" # Obtain this link from the email directly
